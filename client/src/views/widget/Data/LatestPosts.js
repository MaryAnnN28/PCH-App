            ...
            <Grid container spacing={gridSpacing}>
                <Grid item xs={12}>
                    <Grid container alignItems="center" spacing={2}>
                        <Grid item>
                            <CardMedia component="img" image={Dashboard1} title="image" sx={sxPost} />
                        </Grid>
                ...
                <Grid item xs={12}>
                    <Grid container alignItems="center" spacing={2}>
                        <Grid item>
                            <CardMedia component="iframe" src="https://www.youtube.com/embed/668nUCeBHyY" title="image" sx={sxPost} />
                        </Grid>
                        <Grid item xs zeroMinWidth>
                            <Grid container spacing={1}>
                                <Grid item xs={12}>
                ...
                <Grid item xs={12}>
                    <Grid container alignItems="center" spacing={2}>
                        <Grid item>
                            <CardMedia component="img" image={Dashboard2} title="image" sx={sxPost} />
                        </Grid>
                        <Grid item xs zeroMinWidth>
                            <Grid container spacing={1}>
                                <Grid item xs={12}>
